...
namespace eCommerce.API.Repositories
{
    public class UsuarioRepository : IUsuarioRepository
    {
        ...
        {
            new Usuario() {Id = 1, Nome = "Bruno Ferreira",Email = "bruno@gmail.com"},
            new Usuario() { Id = 2, Nome = "Marcelo Rodrigues", Email = "marcelo@gmail.com"},
            new Usuario(){ Id = 3, Nome = "Jessica Amaral",Email = "jessica@gmail.com"}
        };
